...
<div class="col-sm-4">
<input type="text" class="form-control" placeholder="Search by title...." ng-model="sr.title"/>
</div>
<div class="col-sm-2"></div>
<div class="col-sm-4">
<input type="text" class="form-control" placeholder="Search by tags...." ng-model="sr.tag"/>
</div>
</div><br>
<table class="table">
<thead>
...
<tbody>
<%-- <c:forEach items="${blogLt}" var="x"> --%>
<tr ng-repeat="x in bList|filter:sr"> 
<td>{{x.title}}</td>
<td>{{x.author}}</td>
<td>{{x.blogcreationDate}}</td>
<td><a href="blogPage?id={{x.blogId}}">View</a></td>
</tr>
<%-- </c:forEach> --%>
</tbody>
</table>
